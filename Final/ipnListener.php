...
$fp = fsockopen('ssl://www.sandbox.paypal.com', 443, $errno, $errstr, 30);
 ...
 while (!feof($fp)) {
	...
	if (strcmp ($res, "VERIFIED\r\n") == 0) {
		...
		*/
		$email="ierg4210testingmerchant-1@cuhk.edu.hk";
		...
		*/
		...
		$basedigest = $Currency . $MerEmail . $pidList_combine . $qtyList_combine . $priceList_combine . $totalPrice;
		$digest = hash_hmac('sha256', $basedigest, $salt);
		error_log('calculated digest:' . $digest);
